...
<html>
	...
	%>
	<body id="mmain_body" onload="claresearch();">
		<div id=mmain>
			<f:view>
				<h:form id="edit">
					<div id=mmain_opt>
						...
						<a4j:commandButton onmouseover="this.className='a4j_over1'"
							...
							id="sid" value="查询" type="button" action="#{inveCOM.addDetailSearch}"
					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="select a.id,a.inco,a.inna,a.colo,a.inse,b.tyna,c.brde,a.inpr   
											from inve a left join prty b on a.inty = b.inty left join brin c on a.bran = c.bran  
											where 1=1 #{inveCOM.sql} "
