							...
							<tr>
								<td>
									<g:GTable gid="gtable" gtype="grid" gversion="2" gdebug="false"
										gselectsql="
											Select a.inco,b.inna,b.inty,b.inse,b.inpr,b.colo,
											SUM(a.qty) AS qty
											From lode a left join inve b On a.inco = b.inco  
											Where a.biid = '#{CarTransferMB.mbean.biid}'
											and a.obid like '#{CarTransferMB.dbiid}'
