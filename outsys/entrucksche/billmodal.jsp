...
<%
	EntruckScheMB ai = (EntruckScheMB) MBUtil.getManageBean("#{entruckScheMB}");
	...
	<body id=mmain_body>
		<div id=mmain>
			<f:view>
				<h:form id="edit">
					<div id=mmain_nav>
						<a id="linkid" href="#" onclick='Gwin.close("billWin");' class="return" title="返回">装车调度</a>&gt;&gt;
						<b>编辑订单</b>
						<br>
					</div>
					<div id=mmain_opt>
					...
					<a4j:outputPanel id="headButton">
						<div id=mmain_opt>
							<gw:GAjaxButton theme="a_theme" id="updateId" value="保存"
								onclick="startDo();"
								action="#{entruckScheMB.updatebill}" reRender="msg"
								oncomplete="endSave('iframe_outorder');" requestDelay="50"
								rendered="#{entruckScheMB.MOD}" />
							<gw:GAjaxButton theme="a_theme" value="返回" onclick='Gwin.close("billWin");'/>	
						</div>
					</a4j:outputPanel>
						...
						<div id=mmain_cnd>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td>
										<h:inputText id="biid" styleClass="inputtext" size="20"
											value="#{entruckScheMB.outOrderBean.biid}"
									...
									<td>
										<h:inputText id="cuna" size="20" styleClass="inputtext"
											value="#{entruckScheMB.outOrderBean.cuna}" 
											style="readonly:expression(this.readOnly=true);color:#A0A0A0"
											/>
										<h:inputHidden id="cuid"
											value="#{entruckScheMB.outOrderBean.cuid}" />
									</td>
									<td>
										承运商:
									</td>
									<td>
										<h:inputText id="lpna" size="20" styleClass="inputtext"
											value="#{entruckScheMB.outOrderBean.lpco}" disabled="true" />
										<h:inputHidden id="lpco"
											value="#{entruckScheMB.outOrderBean.lpco}" />
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<h:inputText id="chdt" size="20" styleClass="inputtext"
											value="#{entruckScheMB.outOrderBean.chdt}" disabled="true" />
									</td>
									<%-- 
									<td valign="top">
										送达地区:
									...
									<td>
										<h:selectOneMenu id="gead"
											value="#{entruckScheMB.outOrderBean.gead}"
											style="width:130px">
									...
									<td>
										<h:selectOneMenu id="lico"
											value="#{entruckScheMB.outOrderBean.lico}"
											style="width:130px">
											<f:selectItem itemLabel="" itemValue="" />
								...
								<tr>
									...
									<td colspan="7">
										<h:inputText id="orad" value="#{entruckScheMB.outOrderBean.orad}"
								...
								<tr>
									...
									<td colspan="5">
										<h:inputText id="rema" styleClass="inputtext" size="95"
											disabled="true" value="#{entruckScheMB.outOrderBean.rema}" />
									</td>
								</tr>
							</table>
						</div>
								...
								<a4j:outputPanel id="outdetail">
									<g:GTable gid="gtable" gtype="grid" gversion="2" gdebug="false"
										gselectsql="
											...
											Where a.biid = '#{entruckScheMB.outOrderBean.biid}'
											"
										gpage="(pagesize = -1)"
										gcolumn="
											...
											gcid = inse(headtext = 规格,name = inse,width = 90,align = left,type = text,headtype = hidden ,datatype = string);
