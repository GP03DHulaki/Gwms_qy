...
<%
	EntrScheTrPlanMB ai = (EntrScheTrPlanMB) MBUtil
			.getManageBean("#{entrScheTrPlanMB}");
	...
	<body id=mmain_body>
		<div id=mmain>
			<f:view>
				<h:form id="edit">
					<div id=mmain_nav>
						<a id="linkid" href="#" onclick='Gwin.close("billtranWin");' class="return"
							title="返回">备货调度</a>&gt;&gt;
						<b>编辑调拨计划</b>
						<br>
					</div>
					...
					<a4j:outputPanel id="headButton">
						<div id=mmain_opt>
							<gw:GAjaxButton theme="a_theme" id="updateId" value="保存"
								onclick="startDo();" action="#{entrScheTrPlanMB.updatebill}"
								reRender="msg" oncomplete="endSave('iframe_tranplan');" requestDelay="50"
								rendered="#{entrScheTrPlanMB.MOD}" />
							<gw:GAjaxButton theme="a_theme" value="返回"
								onclick='Gwin.close("billtranWin");' />
						</div>
					</a4j:outputPanel>
								...
								<tr>
									...
									<td>
										<h:inputText id="biid" styleClass="inputtext" size="20"
											value="#{entrScheTrPlanMB.tranPlanMBean.biid}"
									...
									<td>
										<h:inputText id="outwhna" size="20" styleClass="inputtext"
											value="#{entrScheTrPlanMB.tranPlanMBean.outwhna}"
											style="readonly:expression(this.readOnly=true);color:#A0A0A0" />
										<h:inputHidden id="cuid"
											value="#{entrScheTrPlanMB.tranPlanMBean.powh}" />
									</td>
									<td>
										调入仓库:
									</td>
									<td>
										<h:inputText id="inwhna" size="20" styleClass="inputtext"
											value="#{entrScheTrPlanMB.tranPlanMBean.inwhna}" disabled="true" />
										<h:inputHidden id="powh"
											value="#{entrScheTrPlanMB.tranPlanMBean.powh}" />
									</td>
								</tr>
								<tr>
									...
									<td>
										<h:inputText id="chdt" size="20" styleClass="inputtext"
											value="#{entrScheTrPlanMB.tranPlanMBean.chdt}" disabled="true" />
									</td>
									<td valign="top">
										线&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;路:
									</td>
									<td>
										<h:selectOneMenu id="lico"
											value="#{entrScheTrPlanMB.tranPlanMBean.lico}"
											style="width:130px">
									...
									<td>
										<h:selectOneMenu id="gead"
											value="#{entrScheTrPlanMB.tranPlanMBean.gead}"
											style="width:130px">
											<f:selectItem itemLabel="" itemValue="" />
								...
								<tr>
									...
									<td colspan="5">
										<h:inputText id="rema" styleClass="inputtext" size="95"
											disabled="true" value="#{entrScheTrPlanMB.tranPlanMBean.rema}" />
									</td>
								</tr>
							</table>
						</div>
								...
								<a4j:outputPanel id="outdetail">
									<g:GTable gid="gtable" gtype="grid" gversion="2" gdebug="false"
										gselectsql="
											...
											Where a.biid = '#{entrScheTrPlanMB.tranPlanMBean.biid}'
											"
										gpage="(pagesize = -1)"
										gcolumn="
