...
<%
	EntrSchePbPlanMB ai = (EntrSchePbPlanMB) MBUtil
			.getManageBean("#{entrSchePbPlanMB}");
	...
	<body id=mmain_body>
		<div id=mmain>
			<f:view>
				<h:form id="edit">
					<div id=mmain_nav>
						<a id="linkid" href="#" onclick='Gwin.close("billpoboWin");' class="return"
							title="返回">备货调度</a>&gt;&gt;
						<b>编辑调拨计划</b>
						<br>
					</div>
					...
					<a4j:outputPanel id="headButton">
						<div id=mmain_opt>
							...
							<gw:GAjaxButton theme="a_theme" value="返回"
								onclick='Gwin.close("billpoboWin");' />
						</div>
					</a4j:outputPanel>
