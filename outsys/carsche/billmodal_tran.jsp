								...
								<tr>
									...
									<td>
										<h:inputText id="biid" styleClass="inputtext" size="20"
											value="#{carScheMB.tranPlanMBean.biid}"
									...
									<td>
										<h:inputText id="outwhna" size="20" styleClass="inputtext"
											value="#{carScheMB.tranPlanMBean.outwhna}"
											style="readonly:expression(this.readOnly=true);color:#A0A0A0" />
										<h:inputHidden id="cuid"
											value="#{carScheMB.tranPlanMBean.powh}" />
									</td>
									<td>
										调入仓库:
									</td>
									<td>
										<h:inputText id="inwhna" size="20" styleClass="inputtext"
											value="#{carScheMB.tranPlanMBean.inwhna}" disabled="true" />
								...
								<tr>
									...
									<td>
										<h:inputText id="chdt" size="20" styleClass="inputtext"
											value="#{carScheMB.tranPlanMBean.chdt}" disabled="true" />
									</td>
									<td valign="top">
										线&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;路:
									</td>
									<td>
										<h:selectOneMenu id="lico"
											value="#{carScheMB.tranPlanMBean.lico}"
											style="width:130px">
									...
									<td>
										<h:selectOneMenu id="gead"
											value="#{carScheMB.tranPlanMBean.gead}"
											style="width:130px">
											<f:selectItem itemLabel="" itemValue="" />
								...
								<tr>
									...
									<td colspan="5">
										<h:inputText id="rema" styleClass="inputtext" size="95"
											disabled="true" value="#{carScheMB.tranPlanMBean.rema}" />
									</td>
								</tr>
							</table>
						</div>
								...
								<a4j:outputPanel id="outdetail">
									<g:GTable gid="gtable" gtype="grid" gversion="2" gdebug="false"
										gselectsql="
											...
											Where a.biid = '#{carScheMB.tranPlanMBean.biid}'
											"
										gpage="(pagesize = -1)"
										gcolumn="
											...
											gcid = newe(headtext = 重量(kg),name = newe,width = 90,align = right,type = text,headtype = sort ,datatype = number,dataformat=0.00,summary=this);
										" />
								</a4j:outputPanel>
							</td>
						</tr>
