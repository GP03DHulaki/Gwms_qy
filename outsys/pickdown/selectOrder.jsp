...
<head>
	...
	<meta http-equiv="keywords" content=下架任务>
	<meta http-equiv="description" content="下架任务">
	...
	<f:view>
		<div id="mmain">
			<h:form id="edit">
				...
				<div id=mmain_cnd>
					<h:outputText value="下架任务:"></h:outputText>
				...
				<a4j:outputPanel id="output">
					<g:GTable gid="gtable" gtype="grid" gversion="2"
						gselectsql="
							SELECT 'PT11080100001' AS vc_voucherid,'2011-08-01 8:30' AS dt_createdate
							FROM temp
						"
						...
						gcolumn="
							...
							gcid = vc_voucherid(headtext = 下架任务,name = vc_voucherid,width = 200,headtype = text,align = left,type = text,datatype=string);
