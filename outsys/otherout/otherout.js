...
function selectWahod(){
	var url = "../../common/waho/waho.jsf?type=4,5,6,99&pwid="+$('edit:whid').value+"&retid=edit:dwhid&retname=";
	showModal(url);
	return false;
}
...
function selectOtherOutSoco()
{
	showModal("selectSoco.jsf","580px","380px");
}
function selectThis(parm1) {
	var obj = parent.document.getElementById("edit:soco");
	obj.value = parm1;
