...
<html>
	...
	<body id='mmain_body' onload="initFrame();endWinShow();">
		<div id='mmain_nav'>
			...
			<font color="#000000"><b>初始化条码</b> </font>
			<br>
		</div>
		<div id='mmain'>
			<f:view>
					...
					<div id="tabDiv">
						<div id="tabsHead">
							...
							<a class="curtab" id="tabs1"
								href="javascript:showTab('tabs1','tabContent1')" title="初始化箱码">初始化箱码</a>
								--%>
							<a class="curtab" id="tabs2"
								href="javascript:showTab('tabs2','tabContent2');"
								title="初始化商品条码">初始化商品条码</a>
						</div>
						<div id="tabsBody">
							<%-- 
							<div id="tabContent1" class="curtab_body">
								<iframe id="iframe_outorder" name="iframe_finOrder" align="top"
									...
									src="<%=request.getContextPath()%>/stocksys/printpackbox/printpackbox.jsf?isAll=0"></iframe>
							</div>
							--%>
							<div id="tabContent2">
								<iframe id="iframe_tranplan" name="iframe_unfinOrder"
									...
									src="<%=request.getContextPath()%>/stocksys/printpackbox/printbarcode.jsf?isAll=0"></iframe>
							</div>
