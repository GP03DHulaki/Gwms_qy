...
<html>
	<head>
		...
		<meta http-equiv="description" content="货主转换计划">
		<script type="text/javascript" src="tran.js"></script>
	</head>

	<body id='mmain_body'>
		<div id='mmain_nav'>
			<font color="#000000">库内处理&gt;&gt;货主转换计划</b>
			<br>
		</div>
		<div id='mmain'>
			<f:view>
				<h:form id="edit">
					...
					<a4j:outputPanel id="queryForm" rendered="#{owTranMB.LST}">
						<div id="mmain_cnd">
							...
							<h:inputText id="outwhna" styleClass="inputtext" size="17"
								onkeypress="formsubmit(event);"
								value="#{owTranMB.sk_obj.frow}" />
							调入货主:
							<h:inputText id="inwhna" styleClass="inputtext" size="17"
								onkeypress="formsubmit(event);"
								value="#{owTranMB.sk_obj.toow}" />
							<br>
							<h:outputText value="调拨类型:" rendered="true" />
							<h:selectOneMenu id="ifib" value="#{owTranMB.sk_obj.ifib}"
							...
							<h:selectOneMenu id="sk_flag" value="#{owTranMB.sk_obj.flag}"
								rendered="true" onchange="doSearch();">
								<f:selectItem itemLabel="全部" itemValue="" />
							...
							组织架构:
							<h:selectOneMenu id="orid" value="#{owTranMB.orid}" onchange="doSearch();">
							...
							<td>
								<a4j:outputPanel id="output">
									<g:GTable gid="gtable" gtype="grid" gversion="2" gdebug="false"
										gselectsql="
											Select distinct a.id,a.biid,a.buty,a.frow,a.toow,a.flag,a.pfwh,a.powh,a.crus,a.crna,a.crdt,a.chus,a.chna,a.chdt,
											...
											WHERE a.#{owTranMB.gorgaSql} #{owTranMB.searchSQL}"
										gpage="(pagesize = 18)"
										gcolumn="gcid = id(headtext = selall,name = selall,width = 20,headtype = checkbox,align = center,type = checkbox,datatype=string);
											...
											gcid = biid(headtext = 调拨计划,name = biid,width = 100,headtype = sort,align = left,type = link,datatype=string,linktype = script,typevalue = javascript:Edit('gcolumn[biid]','gcolumn[frow]','gcolumn[toow]'));
											...
											gcid = frow(headtext = 调出货主,name = outwhna,width = 100,headtype = sort,align = left,type = text,datatype=string);
											gcid = toow(headtext = 调入货主,name = inwhna,width = 100,headtype = sort,align = left,type = text,datatype=string);
					...
					<div style="display: none;">
						<a4j:outputPanel id="renderArea">
							...
							<h:inputHidden id="biid" value="#{owTranMB.mbean.biid}" />
							<h:inputHidden id="frow" value="#{owTranMB.mbean.frow}" />
							<h:inputHidden id="toow" value="#{owTranMB.mbean.toow}" />
						</a4j:outputPanel>
