				...
				<h:form id="edit">
					<div id=mmain_opt>
						<a4j:commandButton id="addDBut" value="添加明細"
							...
							type="button" action="#{owTranMB.addDetails}"
						...
						<a4j:commandButton onmouseover="this.className='a4j_over1'"
							...
							id="sid" value="查询" type="button" action="#{owTranMB.addDetailSearch}"
					...
					<div id=mmain_cnd>
						...
						<h:inputText id="id" styleClass="inputtextedit" size="15"
							value="#{owTranMB.id}" onkeypress="formsubmit(event);" />
						<h:outputText value="商品名称:">
						</h:outputText>
						<h:inputText id="name" styleClass="inputtextedit" size="15"
							value="#{owTranMB.na}" onkeypress="formsubmit(event);" />
						<h:outputText value="规格:">
						</h:outputText>
						<h:inputText id="colo" styleClass="inputtextedit" size="15"
							value="#{owTranMB.colo}" onkeypress="formsubmit(event);" />
						规格码:
						<h:inputText id="inst" value="#{owTranMB.inst}"
						...
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2" gdebug="false"
								gselectsql="select a.id,a.inco,a.inna,a.colo,a.inse,ISNULL(s.uqty,0) AS uqty     
											from inve a LEFT JOIN f_stock_uqty('#{owTranMB.mbean.pfwh}') s ON a.inco=s.inco
											where s.uqty>0 #{owTranMB.sql} "
