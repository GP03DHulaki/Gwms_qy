...
<html>
    ...
    function selectThis(parm1){
		if ( window.dialogArguments.document.getElementById("edit:baco") != null){
			window.dialogArguments.document.getElementById("edit:baco").value=parm1;
		}
		window.close();	
    }
					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="select distinct baco,inco from nwba where bxfl='03'  #{bacoCOM.sql} "
								...
								gcolumn="gcid = 0(headtext = 序号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
									gcid = baco(headtext = 商品条码,name = baco,width = 200,headtype = sort,align = left,type = text,datatype=string);
