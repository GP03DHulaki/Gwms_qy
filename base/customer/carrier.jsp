						...
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								...
								gcolumn="gcid = 0(headtext = 序号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
									gcid = lpco(headtext = 物流商编码,name = lpco,width = 200,headtype = sort,align = left,type = text,datatype=string);
									gcid = lpna(headtext = 物流商名称,name = lpna,width = 220,headtype = sort,align = left,type = text,datatype=string);
							" />
						</a4j:outputPanel>
					</div>
