...
<html>
	<head>
		...
		<meta http-equiv="description" content="号型">
	...
	<body id=mmain_body>
		<div id=mmain>
			<f:view>
				<h:form id="list">
					<a4j:outputPanel id="mdin">
						<div id=mmain_opt>
							<a4j:commandButton id="mdSaveButton" value="新增"
								onclick="addDiv('md',380,110);" onmouseover="this.className='a4j_over'"
								onmouseout="this.className='a4j_buton'" 
								rendered="#{cefoMB.ADD}" styleClass="a4j_but" tabindex="5" />
							<a4j:commandButton id="mdDelButton" value="删除" type="button"
								action="#{cefoMB.delete}"
								onclick="if(!deleteAll('gtable2','md')){return false};"
								reRender="renderArea,list2" oncomplete="endDelDo();"
								requestDelay="50" onmouseover="this.className='a4j_over'"
								onmouseout="this.className='a4j_buton'" styleClass="a4j_but"
								rendered="#{cefoMB.DEL}" />
							<a4j:commandButton onmouseover="this.className='a4j_over'"
								onmouseout="this.className='a4j_buton'" styleClass="a4j_but"
								id="mdSid" value="查询" type="button" action="#{cefoMB.searchMd}"
								reRender="renderArea,list2" requestDelay="50" 
								onclick="startDo();" oncomplete="Gwin.close('progress_id');" />
							<a4j:commandButton value="重置"	onmouseover="this.className='a4j_over'"
								onmouseout="this.className='a4j_buton'" styleClass="a4j_but"
								onclick="clearData('md');" />
						</div>
						<div id=mmain_cnd>
								号型:
							<h:inputText id="mdno" styleClass="inputtext" size="12"
									value="#{cefoMB.mdno}" onkeypress="formsubmit(event);" />
							<a4j:outputPanel id="list2">
								<g:GTable gid="gtable2" gtype="grid" gversion="2"
									gpage="(pagesize=20)"
									gselectsql="Select id,mdno,rema From mdin Where 1=1 #{cefoMB.searchSQL}"
									gcolumn="gcid = id(headtext = selall,name = selall,width = 30,headtype = checkbox,align = center,type = checkbox,datatype=string);
										...
										gcid = -1(headtext = 操作,value=编辑,name = opt,width = 50,headtype = sort,align = center,type = link,linktype = script,typevalue = javascript:Edit('gcolumn[1]','md','gcolumn[2]','gcolumn[3]','','','','',380,110),datatype=string);
										gcid = id(headtext = id,name = id,width = 80,headtype = hidden);
										gcid = mdno(headtext = 号型,name = mdno,width = 100,headtype = sort,align = left,type = text);
				...
				<div style="display: none">
					<h:form id="editMd">
						<div id=mmain_hide>
							...
							<h:inputHidden id="mdid" value="#{cefoMB.bean.mdid}"></h:inputHidden>
						...
						<a4j:outputPanel id="editpanel">
							<table align=center>
								<tr>
									...
									<td>
										<h:inputText id="mdno" styleClass="inputtext"
											value="#{cefoMB.bean.mdno}" />
									</td>
								</tr>
								<tr>
									<td bgcolor="#efefef">
									...
									<td>
										<h:inputText id="mdma" styleClass="inputtext"
											value="#{cefoMB.bean.mdma}" size="56"></h:inputText>
									</td>
								</tr>
								<tr>
									<td colspan="4" align="center">
										<a4j:commandButton id="saveid" action="#{cefoMB.save}"
											...
											onclick="if(!formCheck('md')){return false};"
											oncomplete="endDo('CefoMdWin');"
											onmouseover="this.className='a4j_over'"
											onmouseout="this.className='a4j_buton'" styleClass="a4j_but"
											rendered="#{cefoMB.MOD}" />
										<a4j:commandButton onmouseover="this.className='a4j_over'"
											onmouseout="this.className='a4j_buton'" styleClass="a4j_but"
											value="返回" onclick="hideDiv('CefoMdWin');" />
									</td>
								</tr>
							</table>
						</a4j:outputPanel>
