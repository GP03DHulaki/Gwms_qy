		...
		<a4j:outputPanel id="them">
								<div id=mmain_opt>
									<a4j:commandButton id="saveButton" value="新增"
										onclick="addDiv('7');" onmouseover="this.className='a4j_over'"
									...
									<a4j:commandButton id="delButton" value="删除" type="button"
										...
										onclick="if(!deleteAll('gtable','7')){return false};"
								...
								<a4j:outputPanel id="out_List">
									<g:GTable gid="gtable" gtype="grid" gversion="2"
										gpage="(pagesize=20)"
										gselectsql="Select id, prna,stat,rema From prmo Where 1=1 #{patClassMB.themSql}"
										gcolumn="gcid = id(headtext = selall,name = selall,width = 30,headtype = checkbox,align = center,type = checkbox,datatype=string);
											...
											gcid = -1(headtext = 操作,value=编辑,name = opt,width = 50,headtype = sort,align = center,type = link,linktype = script,typevalue = javascript:Edit(gcolumn[1],'7'),datatype=string);
											gcid = prna(headtext = 主题名称,name = thna,width = 100,headtype = sort,align = left,type = text);
