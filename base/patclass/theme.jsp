		...
		<a4j:outputPanel id="them">
								<div id=mmain_opt>
									<a4j:commandButton id="saveButton" value="新增"
										onclick="addDiv('1');" onmouseover="this.className='a4j_over'"
									...
									<a4j:commandButton id="delButton" value="删除" type="button"
										...
										onclick="if(!deleteAll('gtable','1')){return false};"
								...
								<a4j:outputPanel id="out_List">
									<g:GTable gid="gtable" gtype="grid" gversion="2"
										gpage="(pagesize=20)"
										gselectsql="Select id, thna,stat,rema From toin Where 1=1 #{patClassMB.themSql}"
										gcolumn="gcid = id(headtext = selall,name = selall,width = 30,headtype = checkbox,align = center,type = checkbox,datatype=string);
											...
											gcid = -1(headtext = 操作,value=编辑,name = opt,width = 50,headtype = sort,align = center,type = link,linktype = script,typevalue = javascript:Edit(gcolumn[1],'1'),datatype=string);
											gcid = thna(headtext = 主题名称,name = thna,width = 100,headtype = sort,align = left,type = text);
