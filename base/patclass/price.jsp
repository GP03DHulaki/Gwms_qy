		...
		<a4j:outputPanel id="them">
								<div id=mmain_opt>
									<a4j:commandButton id="saveButton" value="新增"
										onclick="addDiv('6');" onmouseover="this.className='a4j_over'"
									...
									<a4j:commandButton id="delButton" value="删除" type="button"
										...
										onclick="if(!deleteAll('gtable','6')){return false};"
								...
								<a4j:outputPanel id="out_List">
									<g:GTable gid="gtable" gtype="grid" gversion="2"
										gpage="(pagesize=20)"
										gselectsql="Select id, prna+'~'+prna1 as prna,stat,rema From pric Where 1=1 #{patClassMB.themSql}"
										gcolumn="gcid = id(headtext = selall,name = selall,width = 30,headtype = checkbox,align = center,type = checkbox,datatype=string);
											...
											gcid = -1(headtext = 操作,value=编辑,name = opt,width = 50,headtype = sort,align = center,type = link,linktype = script,typevalue = javascript:Edit(gcolumn[1],'6'),datatype=string);
											gcid = prna(headtext = 价格区间,name = prna,width = 100,headtype = sort,align = left,type = text);
											gcid = stat(headtext = 状态,name = stat,width = 80,headtype = sort,align = left,type = mask,typevalue=0:注销/1:有效);
											gcid = rema(headtext = 主题描述,name = rema,width = 200,headtype = sort,align = left,type = text);
										" />
								</a4j:outputPanel>
								</div>
								...
								<table align=center>
									<tr>
										<td colspan="2" width="200px">
											价格:<h:inputText id="prics" styleClass="inputtext" value="#{patClassMB.bean.name}" size="5"/>~<h:inputText id="price" styleClass="inputtext" value="#{patClassMB.bean.name1}" size="5"/>
										</td>
										<td bgcolor="#efefef">
											状态:
										</td>
									...
									<tr >
										<td colspan="4" align="left">
											描述：<h:inputText id="drema" styleClass="inputtext"
									...
									<tr>
										<td colspan="4" align="center">
											<a4j:commandButton id="saveid" action="#{patClassMB.save}"
												...
												onclick="if(!savePrice()){return false};"
												oncomplete="endDo();"
												onmouseover="this.className='a4j_over'"
												onmouseout="this.className='a4j_buton'" styleClass="a4j_but"
