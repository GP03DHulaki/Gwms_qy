				...
				<div id="tabDiv">
					<div id="tabsHead">
						...
						<a class="tabs" id="tabs2"
							href="javascript:showTab('tabs2','tabContent2');" title="商品类别">商品类别</a>
					</div>
					<div id="tabsBody">
							...
							<h:form id="list">
								...
								<a4j:outputPanel id="out_List">
									<g:GTable gid="gtable2" gtype="grid" gversion="2"
										gpage="(pagesize=20)"
										gselectsql="Select id,inty,tyna,upty,leve,stat,rema From prty a Where type='1' #{invClassMB.searchSQL}"
										gcolumn="gcid = id(headtext = selall,name = selall,width = 30,headtype = checkbox,align = center,type = checkbox,datatype=string);
											...
											gcid = id(headtext = ID,name = id,width = 50,headtype = sort,align = left,type = text);
											...
											gcid = upty(headtext = 上级ID,name = upty,width = 100,headtype = sort,align = left,type = mask,typevalue=0:ROOT);
										" />
								</a4j:outputPanel>
							...
							<a4j:outputPanel id="editpanel">
								<table align=center>
									<tr>
										...
										<td>
											<h:selectOneMenu id="upty" 
												value="#{invClassMB.bean.upty}"
												styleClass="selectItem">
												<f:selectItem itemLabel="" itemValue="" />
												<f:selectItems value="#{invClassMB.list}" />
											</h:selectOneMenu>
										</td>
										<td bgcolor="#efefef">
											状态:
									...
									<tr>
										<td colspan="4" align="center">
											...
											<a4j:commandButton id="saveid" action="#{invClassMB.save}"
