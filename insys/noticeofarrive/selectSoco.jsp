					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="Select distinct a.biid,c.suna,b.crdt From pubd a join pubm b on a.biid=b.biid join suin c on b.suid=c.suid Where (b.flag='11' or b.flag='21') 
									and a.tqty<>a.qty
								...
								gcolumn="gcid = 0(headtext = 序号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
									...
									gcid = suna(headtext = 供应商,name = suna,width = 250,headtype = sort,align = left,type = text,datatype=string);
									gcid = crdt(headtext = 采购日期,name = crdt,width = 110,headtype = sort,align = left,type = text,datatype=datetime,,dataformat=yyyy-MM-dd);
							" />
						</a4j:outputPanel>
					</div>
