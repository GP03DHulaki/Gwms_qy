					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="SELECT a.id,a.biid,a.suid,b.suna FROM pubm a join suin b ON a.suid = b.suid WHERE a.flag > 11 and a.flag < 99 #{poinMB.sql} "
								...
								gcolumn="gcid = 0(headtext = 序号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
									gcid = biid(headtext = 采购订单,name = biid,width = 210,headtype = sort,align = left,type = text,datatype=string);
