	...
	<body id="mmain_body" onload="initAdd();">
		<div id="mmain_nav">
			<font color="#000000">入库处理&gt;&gt;<a href="po.jsf"
				class="return" title="返回">订单</a>&gt;&gt;</font><b>添加采购订单</b>
			<br>
		</div>
		<f:view>
			<div id="mmain">
				<h:form id="edit">
					<div id=mmain_opt>
						<a4j:commandButton onmouseover="this.className='a4j_over'"
							rendered="#{pubmMB.ADD}" onmouseout="this.className='a4j_buton'"
							styleClass="a4j_but" id="addId" value="保存" type="button"
							action="#{pubmMB.addHead}" reRender="msg,showHead,vc_voucherid"
