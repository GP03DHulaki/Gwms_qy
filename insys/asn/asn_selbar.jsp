...
<html>
	...
	<%
		...
		ValueBinding binding = context.getApplication().createValueBinding("#{asnMB}");
				...
				<h:form id="edit">
					<div id=mmain_opt>
						<a4j:commandButton onmouseover="this.className='a4j_over1'"
							...
							id="sid" value="查询" type="button" action="#{asnMB.searchBar}"
						...
						<a4j:commandButton type="button" value="打印选定"
							...
							action="#{asnMB.printCode}" rendered="true"
							styleClass="a4j_but1"
						...
						<a4j:commandButton type="button" value="打印全部"
							onmouseover="this.className='a4j_over1'"
							onmouseout="this.className='a4j_buton1'"
							action="#{asnMB.printCodeAll}" rendered="true"
							styleClass="a4j_but1"
					...
					<div id=mmain_cnd>
						...
						<h:inputText id="baco" styleClass="inputtextedit" size="15"
							value="#{asnMB.sk_baco}" onkeypress="formsubmit(event);" />
						<h:outputText value="商品编码:">
						</h:outputText>
						<h:inputText id="inco" styleClass="inputtextedit" size="15"
							value="#{asnMB.sk_inco}" onkeypress="formsubmit(event);" />
					</div>

					<div id=mmain_cnd >
					<a4j:outputPanel rendered="#{asnMB.baraddshow}" >
						...
						<div id="ExtraFunction" style="display: none;height: 10px; margin-left:13px;">
							...
							<a4j:commandButton onmouseover="this.className='a4j_over1'"
								onmouseout="this.className='a4j_buton1'" styleClass="a4j_but1"
								id="addBar" value="添加尾箱" type="button" action="#{asnMB.addBar}"
					...
					<div id="mmain_free">
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="select id,baco,inco,qty from bain where moid = 'ASN' and bbid = '#{asnMB.mbean.biid }' #{asnMB.selbarroidsql} #{asnMB.selbarsql }"
					...
					<a4j:outputPanel id="renderArea">
						...
						<h:inputHidden id="filename" value="#{asnMB.fileName}" />
						<h:inputHidden id="roid" value="#{asnMB.roid}" />
						<h:inputHidden id="msg" value="#{asnMB.msg}" />
						<h:inputHidden id="baraddshow" value="#{asnMB.baraddshow}" />
					</a4j:outputPanel>
					</div>
				</h:form>
			</f:view>
