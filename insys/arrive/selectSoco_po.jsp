					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="Select a.biid,b.suna,a.indt From pubm a	
									left join suin b on a.suid=b.suid
									Where (a.flag<>'99' AND a.flag<>'100') 
								...
								gcolumn="gcid = 0(headtext = 序号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
									...
									gcid = indt(headtext = 预约到货日期,name = indt,width = 125,headtype = sort,align = left,type = text,datatype=datetime,,dataformat=yyyy-MM-dd HH:mm);
							" />
						</a4j:outputPanel>
					</div>
