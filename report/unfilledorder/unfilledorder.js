...
function selectWaho1(retid,retname){
	showModal('../../common/waho/waho.jsf?type=1,5,6,7,9&retid='+retid+'&retname='+retname+'&pwid=all');
...
function clearData(){
	...
	if($("edit:tb_start_date")!=null){
		$("edit:tb_start_date").value = "";
	}
	if($("edit:tb_end_date")!=null){
		$("edit:tb_end_date").value = "";
	}
	if($("edit:pa_start_date")!=null){
		$("edit:pa_start_date").value = "";
	}
	if($("edit:pa_end_date")!=null){
		$("edit:pa_end_date").value = "";
	}
	if($("edit:jj_start_date")!=null){
		$("edit:jj_start_date").value = "";
	}
	if($("edit:jj_end_date")!=null){
		$("edit:jj_end_date").value = "";
	}
	if($("edit:bh_start_date")!=null){
		$("edit:bh_start_date").value = "";
	}
	if($("edit:bh_end_date")!=null){
		$("edit:bh_end_date").value = "";
	}
	if($("edit:jh_start_date")!=null){
		$("edit:jh_start_date").value = "";
	}
	if($("edit:jh_end_date")!=null){
		$("edit:jh_end_date").value = "";
	}
	if($("edit:fhdy_start_date")!=null){
		$("edit:fhdy_start_date").value = "";
	}
	if($("edit:fhdy_end_date")!=null){
		$("edit:fhdy_end_date").value = "";
	}
	if($("edit:kddy_start_date")!=null){
		$("edit:kddy_start_date").value = "";
	}
	if($("edit:kddy_end_date")!=null){
		$("edit:kddy_end_date").value = "";
	}
