				...
				<h:form id="list">
					...
					<a4j:outputPanel id="out_List">
						<g:GTable gid="gtable" gtype="grid" gversion="2"  gdebug="true"
							gpage="(pagesize=20)"
							gselectsql="Select waho.id,whid,ewid,whna,pwid,whfl,whty,waho.chie,waho.addr,waho.tele,wogr,waho.orid,g.orna,cofl,volu,vole,vowi,vohe,bear,waho.stat,waho.rema From waho left join orga g on g.orid = waho.orid Where waho.whty='4' and whid not in(select whid from bain) #{warehouseMB.sql}"
