...
function showNullWhid()
{
	showModal('showNullWhid.jsf?isAll=all');
}
...
function ShowIncoDetail(baco,whid){
	Gwallwin.winShowmask("TRUE");
	showModal('showdetail.jsf?baco='+baco+'&whid='+whid+'&time='+new Date(),760,500);
	Gwallwin.winShowmask("FALSE");
}