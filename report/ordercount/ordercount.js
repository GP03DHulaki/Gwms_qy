...
function clearSearchKey(type){
	if(type==1){
		...
		if(param=="0"){
			textClear('list','sk_voucherid,start_date,end_date,sk_expressname,sk_invcode,sk_districtname,sk_customername,b_date,e_date,iscancle,stat,whid,start_date_padt,end_date_padt,whfl');
			if($('edit:sk_flag')){
		...
		textClear('list','sk_voucherid,start_date,end_date,sk_flag,sk_expressname,sk_barcode,sk_districtname,sk_customername,b_date,e_date,iscancle,stat,whid,start_date_padt,end_date_padt,whfl');
	}
