...
if (request.getParameter("retbsul") != null) {
	ai.setRetbsul(request.getParameter("retbsul"));
}
%>
...
function select1(){
	...
	var isGwin = Gwin && document.GwinID;//是否Gwin方式弹出.
		...
		if ( retbsul != "" && retbsul != null){
			isGwin ? parent.document.getElementById(retbsul).value = bsul : callBack.document.getElementById(retbsul).value=bsul;
		}
			...
			<f:view>
				<h:form id="edit">
					...
					<div id="hiddenDiv" style="display: none;">
						...
						<h:inputHidden id="retbsul" value="#{invclassCOM.retbsul}" />
						<h:inputHidden id="nodevalue" value="" />
						<h:inputHidden id="bsul" value="" />
					</div>
				</h:form>
			</f:view>
		</div>
