					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="SELECT DISTINCT biid,'' as cuid,'' as cuna,orid FROM slst a where 1=1 AND a.orid like '#{sessionScope['orid']==''?'#':sessionScope['orid']}%' 
									 #{outOrderCOM.sql} "
								...
								gcolumn="gcid = 0(headtext = 序号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
									...
									gcid = orid(headtext = 组织编码,name = orid,width = 100,headtype = hidden,align = left,type = text,datatype=string);
							" />
						</a4j:outputPanel>
					</div>
