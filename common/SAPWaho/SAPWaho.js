    ...
    function selectThis(parm1,parm2){
    	...
    	if ( retid != "" && retid != null){
    		isGwin ? parent.document.getElementById(retid).value = parm2 : callBack.document.getElementById(retid).value=parm2;
		}
		
		if ( retname != "" && retname != null && parm2 != null){
			isGwin ? parent.document.getElementById(retname).value = parm1 : callBack.document.getElementById(retname).value=parm1;
		}
