var Gtree = {
	...
	getFiles: function ( treeId, obj, line, bool, rank, isfater, isrootf){
			...
			var html = '<div id="div_'+obj.id+'" url="'+obj.url+'" value="'+obj.value+'" select="'+obj.select+'" link="'+obj.link+'" lable="'+obj.lable+'"'
	...
	getFile: function ( treeId, obj, line, bool, rank, isfater, isrootf ){
			...
			var file = '<span id="fl_'+obj.id+'" treeId="'+treeId+'" url="'+obj.url+'" value="'+obj.value+'" select="'+obj.select+'" link="'+obj.link+'" lable="'+obj.lable+'">';
			if(this.treeList[treeId].loadall){
				if(obj.select){
