    ...
    function selectThis(parm1,parm2,lico){
		...
		/*
		if (callBack && callBack.document.getElementById('edit:lico')){
			callBack.document.getElementById('edit:lico').value=lico;
		}else{
			parent.document.getElementById('edit:lico').value=lico;
		}
		
		if(callBack && callBack.document.getElementById('edit:stus')){
			callBack.document.getElementById('edit:stus').focus();
		}else{
			parent.document.getElementById('edit:stus').focus();
		}*/
