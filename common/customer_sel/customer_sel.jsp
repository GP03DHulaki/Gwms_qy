...
<%@page import="com.gwall.common.CustomerCOM"%>
...
<html>
	<head>
		...
		<script type="text/javascript" src='customer_sel.js'></script>
	</head>
					...
					<div id=mmain_free>
						<a4j:outputPanel id="output">
							<g:GTable gid="gtable" gtype="grid" gversion="2"
								gselectsql="SELECT cuid,cuna,lico FROM cuin where 1=1 #{customerCOM.sql} "
								gwidth="550" gpage="(pagesize = 20)" gdebug="false"
								growclick="selectThis('gcolumn[cuid]','gcolumn[cuna]','gcolumn[lico]')"
