...
<html>
	<head>
       ...
       window.name='search';
		...
		<script>
  <!--
    function selectThis(deptid,deptname){	
    	//部门编码
						...
						<td align="center">
							<a4j:outputPanel id="output">
								<g:GTable gid="gtable" gversion="2" gtype="grid"
									gselectsql="
									SELECT vc_deptid,nv_deptname,nv_remark FROM gt_dept 
									WHERE 1=1 "
									gpage="(pagesize = 20)"
									growclick = "selectThis('gcolumn[1]','gcolumn[2]')"
									gcolumn="
										gcid = 0(headtext = 行号,name = rowid,width = 30,headtype = text,align = center,type = text,datatype=string);
										gcid = vc_deptid(headtext = 部门编码,name = vc_deptid,width = 100,headtype = sort,align = center,type = text,datatype=string);
										gcid = nv_deptname(headtext = 部门名称,name = nv_deptname,width = 100,headtype = sort,align = center,type = text,datatype=string);
										gcid = nv_remark(headtext = 备注,name = nv_remark,width = 300,headtype = sort,align = center,type = text,datatype=string);
									" />
							</a4j:outputPanel>
						</td>
					</tr>
